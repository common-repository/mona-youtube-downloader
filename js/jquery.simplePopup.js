	...
	var methods = {
	    ...
	    *******************************/			
	    ...
	    positionPopup: function() {
			...
			var windowHeight = $(window).height(); console.log(windowHeight);
			var popupWidth = object.width();		 console.log(popupWidth);		
			var popupHeight = object.height(); console.log(popupHeight);

			var topPos = (windowHeight / 2) - (popupHeight / 2); console.log(topPos);
			var leftPos = (windowWidth / 2) - (popupWidth / 2); console.log(leftPos);
